...
export function runPre(brief, opts = {}) {
  ...
  spec._slopRules = slopRules; // carry for buildPreBundle bullet append + slop-test.md emit
  ...
  // The enforced gate is post-hoc (`aesthete-post --slop-gate`); this checklist is advisory.
  if (outDir) {
    fs.mkdirSync(outDir, { recursive: true });
    fs.writeFileSync(path.join(outDir, 'slop-test.md'), renderSlopTest(slopRules), 'utf8');
  }
