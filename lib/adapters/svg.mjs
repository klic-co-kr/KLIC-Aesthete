...
function geomNode(c, tag, matrix, nextSeq, viewport) {
  ...
  return {
    ...
    style: tag === 'text'
      ? { fontSize: fs, luminance: Number(luminance.toFixed(3)), opacity, color: fill || stroke || '#111827', bg: '#ffffff', filled: fill !== null, role }
      : { fontSize: fs, luminance: Number(luminance.toFixed(3)), opacity, color: stroke || '#111827', bg: fill || '#ffffff', filled: fill !== null, role },
  };
}
