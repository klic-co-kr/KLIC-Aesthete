...
function nodeFromSp(sp, idx, bbox) {
  ...
  return {
    ...
    style: {
      fontSize: sz,
      luminance: 0.1,
      // NO color/bg. This adapter does not read <a:solidFill>/theme colors, and asserting
      // '#111827' on '#ffffff' made every deck report a constant ~17:1 contrast as if measured,
      // while any nested shape read as white-on-white (a manufactured WCAG 1.4.11 finding).
      // Omitting them lets hierarchy report coverage honestly and keeps the color signatures
      // silent on data that was never extracted. See README "Honest limitations".
