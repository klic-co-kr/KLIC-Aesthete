...
export const SIGNATURES = [
  ...
  {
    // Ported from @gessobuild/anti-slop v0.4.2 (MIT) "overused-font-stack" — their FLAG tier,
    // mapped here to P2 advisory for the same reason: a deliberate Inter body under a
    // distinctive display face is defensible, so this reports without gating. Exact-match on
    // the family name (quote-stripped, lowercased by the scanner): "Inter Display" is a
    // different cut and does not fire — absence of a fuzzy match is the conservative choice.
