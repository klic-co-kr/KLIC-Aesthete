...
export const DEFAULT_THRESHOLDS = {
  ...
  // --- 2026-08 absorption of @gessobuild/anti-slop v0.4.2 (MIT) — thresholds mirror the
  // upstream rule calibration where one exists (dark-glow blur/alpha/saturation bands,
