...
import { hexToHsl, luminanceFromStyle, luminanceWeight, contrastRatio, relativeLuminance, parseHex } from './color.mjs';
  ...
  },
  {
    ...
    detect(ctx, t) {
      ...
      for (const n of ctx.nodes) {
        ...
        const key = `${n.bbox.w}x${n.bbox.h}:${n.style.bg}`;
      ...
      for (let i = 0; i < ctx.nodes.length; i++) {
        ...
        if ((tally.get(`${n.bbox.w}x${n.bbox.h}:${n.style.bg}`) || 0) > t.maxRepeats) continue;
