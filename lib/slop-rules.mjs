...
const UNIVERSAL = {
  bullets: [
    ...
    // --- 2026-08 absorption of @gessobuild/anti-slop v0.4.2 (MIT): copy-axis tells that are
    // medium-independent. ---
...
const MEDIUM_EXTRA = {
  html: {
    bullets: [
      ...
      // --- anti-slop absorption: CSS/DOM tells (detection = lib/slop/signatures/decoration.mjs
      // + imagery.mjs; these bullets are the prevention mirror). ---
