...
const NEGATION_SPEC = {
  ...
  layout: [
    ...
    ['connector endpoints buried inside node shapes — end edges at the node boundary (clip the centre-to-centre line at the edge: t = min(hw/|dx|, hh/|dy|)), then retreat the arrowhead 4–8px so the tip clears the fill'],
