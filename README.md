...
| `decoration` | 11 | emoji-in-heading · **emoji-in-body** (subdivision flags excluded) · italic heading (Hallmark gate 38a) · icon saturation · decorative scale/rotate animation · **side-tab border** (Impeccable's #1 AI-UI tell) · **bounce easing** · **hover transform** · **pulse** · **marquee** · **blink cursor** |
